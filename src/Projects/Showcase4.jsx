      ...
      <div className="hero-content flex-col lg:gap-10 lg:flex-row-reverse">
        ...
        <div className="card flex-shrink-0 w-full max-w-sm">
          <div className="card-body">
            ...
            <p className="py-6">
              ● NFT-Market-place is a MERN stack single-page web application.{" "}
              <br />
            ...
            <div className="flex  space-x-5 items-center">
              ...
              <div className="px-4 py-2 bg-[#161616] rounded-full">
                <SiTailwindcss className="text-green-600" />
              </div>
            </div>
            <div className="mt-2 flex items-center space-x-5">
              <div
                onClick={() =>
                  window.open(
                    "https://zippy-crumble-b93ee9.netlify.app/",
                    "_blank"
                  )
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://github.com/Ashik465/nft-market-place-community",
                    "_blank"
                  )
                }
              >
